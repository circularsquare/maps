...
img = np.array(Image.open('globalwater2x.png'))
print('mask loaded:', img.shape)
...
print('step2', border.mean(), water.mean())
...
plt.tight_layout()
plt.savefig('globalwaterf2x.png')
print('saved globalwaterf2x.png')
