...
## Ruled 2026-09-14 by Anita: yes to all three, Ukraine stays as built

*"yes keep orthodox, draw pre-war, leavae unrescaled."*

Orthodox stays one node (`christianity.orthodox`, option (a)), with no jurisdiction split. Crimea,
Sevastopol, Donetsk and Luhansk stay drawn from the pre-war rounds, with `note_public` as written.
The level stays at 2005-2013's; round 11 is a witness only. Nothing to rebuild.
